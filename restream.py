...
handler = RotatingFileHandler(LOG_PATH, maxBytes=510241024, backupCount=3)
logging.basicConfig(
    level=logging.INFO,
...
<p>40 kbps mono MP3 stream</p></body></html>"""
...
def load_playlist_ids(name, force=False):
    ...
    try:
        ...
        # ✅ Reverse order so latest video plays first
